...
typedef union
{
    ...
    struct
    {
        ...
        uint32_t alive:   1; // led relay timer1
        uint32_t lcd:     1; // inf
...
extern void alive_ctrl_dlps(bool allowenter);

extern void lcd_ctrl_dlps(bool allowenter);
...
extern void SkyBleMesh_lcdexit(void);
