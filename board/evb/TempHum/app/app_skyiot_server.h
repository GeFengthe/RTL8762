...
//#define ENV_DETECT_TIME                 (1*60*1000) // 默认1min检测一次环�?
#define WRITE_DEFAULT_TIME              (5*1000)   	// 默认�?s据状态写flash
...
#define BATT_WARING                     1           // �豸�͵���ֹͣ
#define BATT_WARING_RANK                2000        // ֹͣ��ѹ
#define BATT_THRESHOLD_VAL              100         // �ϱ���ѹ��ֹͣ��ѹ��ֵ
#define BATT_TIMEOUT                    10*60*1000  // 电压采集时间周期

#define BLEMESH_REPORT_FLAG_TEM         0x01         //00000001     �¶ȱ�־
#define BLEMESH_REPORT_FLAG_HUM         0x02         //00000010     ʪ�ȱ�־
#define BLEMESH_REPORT_FLAG_BAT         0x04        // 00000100     ������־
...
typedef enum
{
    ...
    PROV_SUCCESS_TIMEOUT,       //入网成功定时�?
    DISPLAY_LCD_TIMEOUT,         //亮灯定时�?
} SW_TIMER_MSG_TYPE;

typedef enum
{
    MESH_PROVISION_STATE_START,         //0 开始入�?
    MESH_PROVISION_STATE_FAILED,        //1
    MESH_PROVISION_STATE_SUCCEED,       //2
    MESH_PROVISION_STATE_UNPROV,        //未入�?   
