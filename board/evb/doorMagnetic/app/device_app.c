...
void app_handle_gap_msg(T_IO_MSG *p_gap_msg)
{
    ...
    case GAP_MSG_LE_EXT_ADV_STATE_CHANGE:
        {
            gap_sched_handle_ext_adv_state_evt(gap_msg.msg_data.gap_ext_adv_state_change.adv_handle,
...
T_APP_RESULT app_gap_callback(uint8_t cb_type, void *p_cb_data)
{
    ...
    switch (cb_type)
    {
        /* common msg*/
#if GAP_SCHED_BT5_AE
    case GAP_MSG_LE_VENDOR_AE_SCHEME:
        APP_PRINT_INFO1("GAP_MSG_LE_VENDOR_AE_SCHEME: cause 0x%x",
