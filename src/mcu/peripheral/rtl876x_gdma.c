...
void GDMA_Init(GDMA_ChannelTypeDef *GDMA_Channelx, GDMA_InitTypeDef *GDMA_InitStruct)
{
    ...
    if (GDMA_InitStruct->GDMA_Gather_En == 1 &&
        ((GDMA_Channelx == GDMA_Channel1) | (GDMA_Channelx == GDMA_Channel3)))  //GDMA_GatherCount
    {
    ...
    if (GDMA_InitStruct->GDMA_Scatter_En == 1 &&
        ((GDMA_Channelx == GDMA_Channel1) | (GDMA_Channelx == GDMA_Channel3)))
    {
    ...
    if (GDMA_InitStruct->GDMA_Multi_Block_En == 1 &&
        ((GDMA_Channelx == GDMA_Channel0) | (GDMA_Channelx == GDMA_Channel2)))
    {
    ...
    if (GDMA_InitStruct->GDMA_DestHandshake >= 24)
    {
