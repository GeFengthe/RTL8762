...
/**
 * @defgroup MP_Cmd_Exported_Macros MP Command Exported Macros
 * @brief
 * @{
 */
...
/**
 * @defgroup MP_Cmd_Exported_Types MP Command Exported Types
 * @brief
 * @{
 */
...
/**
 * @defgroup MP_Cmd_Exported_Functions MP Command Exported Functions
 * @brief
 * @{
 */
/**
