...
void light_handle_sw_timer_msg(T_IO_MSG *io_msg)
{
    ...
    case UNPROV_TIMEOUT:
        {
            ...
            {
                ali_uuid_t *p_dev_uuid;
                p_dev_uuid = (ali_uuid_t *)mesh_node.dev_uuid;
                p_dev_uuid->feature.silent_adv = 1;
                mesh_node.udb_interval = 600;
                //beacon_stop();
    ...
    case PROV_SUCCESS_TIMEOUT: /*change_scan_param_timer*/
        {
