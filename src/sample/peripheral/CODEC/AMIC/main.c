...
#define GDMA0_Channel_AMIC_IRQn         GDMA0_Channel0_IRQn
#define GDMA0_Channel_AMIC_Handler      GDMA0_Channel0_Handler
...
/**
  ...
  * @return  void
  */
void Driver_AMIC_Codec_Init(void)
{
...
/**
  ...
  * @return  void
  */
void Driver_AMIC_I2S_Init(void)
{
...
void Driver_GDMARx_Init(void)
{
    ...
    NVIC_InitStruct.NVIC_IRQChannel = GDMA0_Channel_AMIC_IRQn;
...
void amic_demo(void)
{
    ...
    Driver_AMIC_I2S_Init();
    Driver_UART_Init();
    Driver_GDMARx_Init();
    Driver_AMIC_Codec_Init();
...
* @return  void
*/
void GDMA0_Channel_AMIC_Handler(void)
{
