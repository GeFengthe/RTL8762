...
/** @defgroup  POS Application
    * @brief This file handles BLE pos smart application routines.
    * @{
    */
/*============================================================================*
 *                              Variables
...
T_SERVER_ID pos_srv_id;  /**< Service id */


uint32_t gTimeParaValue;
...
/** @defgroup  POS_SMART_GAP_CALLBACK GAP Callback Event Handler
...
/** @} */ /* End of group POS_GAP_CALLBACK */


/** @defgroup  POS_SEVER_CALLBACK Profile Server Callback Event Handler
...
T_APP_RESULT app_profile_callback(T_SERVER_ID service_id, void *p_data)
{
    ...
    else if (service_id == pos_srv_id)
    {
        T_POS_CALLBACK_DATA *p_pos_cb_data = (T_POS_CALLBACK_DATA *)p_data;
        switch (p_pos_cb_data->msg_type)
        {
        case SERVICE_CALLBACK_TYPE_INDIFICATION_NOTIFICATION:
            {
                switch (p_pos_cb_data->msg_data.notification_indification_index)
                {
                case POS_NOTIFY_LEVEL_ENABLE:
                    {
                        APP_PRINT_INFO0("POS_NOTIFY_ENABLE");
                        os_timer_start(&xTimerPOS);
                    }
                    break;

                case POS_NOTIFY_LEVEL_DISABLE:
                    {
                        APP_PRINT_INFO0("POS_NOTIFY_DISABLE");
                        os_timer_stop(&xTimerPOS);
                    }
                    break;
                default:
        ...
        case SERVICE_CALLBACK_TYPE_READ_CHAR_VALUE:
            {
                if (p_pos_cb_data->msg_data.read_value_index == POS_READ_LEVEL)
                {
                }
            }
            break;
...
/** @} */ /* End of group POS_SERVER_CALLBACK */
/** @} */ /* End of group POS_APP */
/** @} */ /* End of group POS_DEMO */
