...
void DataUART_Init(void)
{
    ...
    uartInitStruct.RxDmaEn = UART_DMA_ENABLE;
    /* Baudrate = 9600 */
...
void UART0_Handler(void)
{
    ...
    for (i = 0; i < len; i++)
    {
        APP_PRINT_INFO1("%x", GDMA_RevBuffer[offset - len + i]);
    }
}
/**
