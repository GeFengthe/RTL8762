...
#ifndef _BEACON_SAMPLE_SERVICE_H_
#define _BEACON_SAMPLE_SERVICE_H_
...
#include "beacon_sample_config.h"
...
typedef enum
{
    BEACON_SAMPLE_SERVICE_PARAM_V1_READ_CHAR_VAL = 0x01,
} T_BEACON_PARAM_TYPE;
...
#define BEACON_READ_V1_MAX_LEN               300
...
typedef union
{
    ...
    T_BEACON_WRITE_MSG write;
} T_BEACON_UPSTREAM_MSG_DATA;
...
typedef struct
{
    ...
    T_BEACON_UPSTREAM_MSG_DATA msg_data;
} T_BEACON_CALLBACK_DATA;
