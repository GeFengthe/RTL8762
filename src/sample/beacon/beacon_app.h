...
#ifndef _BEACON_APP__
#define _BEACON_APP__
...
#define MAJOR_ID_OFFSET                       25
#define MINOR_ID_OFFSET                       27
#define RSSI_OFFSET                       29
#define UUID_DATA_LENGTH                      16
#define ID_DATA_LENGTH                        2
#define TX_POWER_DATA_LENGTH                  1
#endif
/*============================================================================*
 *                              Variables
 *============================================================================*/
extern T_SERVER_ID bas_srv_id;  /**< Battery service id */
extern T_SERVER_ID beacon_srv_id;  /**< Battery service id */
#if defined(DEVICE_CONNECTABLE)
extern uint8_t adv_data[30];
extern uint8_t rx_char[42];
extern bool modify_adv_interval;
