...
/**
 * @brief  Get the lps wakeup informations.
 *
 * If the values of wakeup count, wakeup time, wakeup totol time have not changed,
 * it means that the device not enter into dlps.
 *
 * @param[out] p_wakeup_count  Get wakeup count.
 * @param[out] p_wakeup_time  Get wakeup time.
 * @param[out] p_total_time  Get wakeup total time.
 * @return  none
*/
