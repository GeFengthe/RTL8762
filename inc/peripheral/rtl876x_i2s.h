...
/**
  * @brief  Returns the send error counter value by the I2Sx peripheral.
  * @param  I2Sx: To select I2Sx peripheral, where x can be: 0 or 1.
  * @retval The send error counter value .
  */
...
/**
  * @brief  Returns the reception error counter value by the I2Sx peripheral.
  * @param  I2Sx: To select I2Sx peripheral, where x can be: 0 or 1.
...
/**
  ...
  * @param  I2Sx: To select I2Sx peripheral, where x can be: 0 or 1.
  * @param  NewState: new state of the bytes sequence.
  *   This parameter can be: ENABLE or DISABLE.
  * @retval None.
  */
...
/**
  ...
  * @param  I2Sx: To select I2Sx peripheral, where x can be: 0 or 1.
  * @param  NewState: new state of the left and right channel data sequence.
  *   This parameter can be: ENABLE or DISABLE.
  * @retval None.
  */
...
/**
  ...
  * @param  I2Sx: To select I2Sx peripheral, where x can be: 0 or 1.
  * @param  NewState: new state of MCLK output.
  *   This parameter can be: ENABLE or DISABLE.
  * @retval None.
  */
...
/**
  * @brief Configure BClk clock parameter.
  * @param  I2Sx: To select I2Sx peripheral, where x can be: 0 or 1.
  * @param  I2S_BClockMi: Mi parameter.
  * @param  I2S_BClockNi: Ni parameter.
  * @retval execution status: SET: success, RESET: failure.
  */
...
/**
  * @brief Configure BClk clock parameter.
  * @param  I2Sx: To select I2Sx peripheral, where x can be: 0 or 1.
  * @retval execution status: SET: BLCK is updating, RESET: BLCK update is done.
  */
...
/**
  ...
  * @param  I2Sx: To select I2Sx peripheral, where x can be: 0 or 1.
  * @param  I2S_ChannelType: the channel type used for the I2S communication.
  * @retval execution status: void.
  */
